    ...
    <div class="py-5 shadow-sm bg-white  z-50 fixed w-full left-0 right-0 top-0 transition-all bg-white">
        <div class="container">
            <div class="flex gap-4 items-center justify-between ">
                <strong><a class="logo py-1" href="/" style="font-size: 30px; color:magenta">Randap</a></strong>
                ...
                <div
                    ...
                    <div class="navbar mr-4 flex">
                        ...
                        <li><a class="mx-3 text-base font-medium text-pgray-600 hover:text-primary-500"
                                href="{{route('actuality.index')}}">Actualité</a></li>

                        <li><a class="mx-3 text-base font-medium text-pgray-600 hover:text-primary-500"
                                href="{{route('about.index')}}">A propos</a></li>
                        @auth

                        <li class="dropdown relative has-child"><a
                                class="mx-3 text-base font-medium text-pgray-600 hover:text-primary-500"
                                href="{{route('account.index')}}">Mon Compte</a>
                            <div class="drop-down-menu min-w-[150px]">

                                <a class="block px-5 py-1 text-pgray-600 hover:text-primary-500"
                                    href="{{route('account.index')}}">Mon profil
                                </a>

                                <a class="block px-5 py-1 text-pgray-600 hover:text-primary-500"
                                    href="{{route('account.yearbook')}}">Annuaire
                                </a>
                                <a class="block px-5 py-1 text-pgray-600 hover:text-primary-500"
                                    href="{{route('job.index')}}">Offres d'emploies
                                </a>
                            </div>
                        </li>
                        ...
                        <li><a class="mx-3 text-base font-medium text-pgray-600 hover:text-primary-500"
                                href="{{route('auth.logout')}}">Déconnexion</a></li>
                        @endauth
    ...
    <div class="hidden navbar-menu relative z-50 transition duration-300">
        ...
        <nav
            ...
            <div class="flex items-center mb-8 justify-between"><a
                    ...
                    href="/">Randap</a><button class="navbar-close"><svg
            ...
            <div>
                <ul class="mobile-menu">
                    ...
                    <li class="mb-1 rounded-xl"><a
                            class="block p-3 text-sm text-pgray-500 hover:bg-primary-50/50  hover:text-primary-500 rounded-xl"
                            href="{{route('auth.signin')}}">Déconnexion</a></li>
